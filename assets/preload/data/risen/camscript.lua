...
local xx = 725; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 250; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 1100; -- Same code as above, but for boyfriend left, right
local yy2 = 550; -- Same code as above, but for boyfriend up, down
local xx3 = 320; -- Same code as above, but for girlfriend left, right
local yy3 = 550; -- Same code as above, but for girlfriend, up, down
...
function onUpdate(elapsed) -- The Main Code
