                ...
                local xx = 425; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
                ...
                local xx2 = 1050; -- Same code as above, but for boyfriend left, right
                ...
                function onEvent(n)
                    ...
                    if n == 'removeBinary' then
                        ...
                        doTweenAlpha('binaryEndAlpha', 'arena', 1, 3, 'linear')
                        xx = 425
                        xx2 = 1050
                        yy2 = 600
                    end
